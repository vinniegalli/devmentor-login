# DevMentor Brasil - Página de Login com HTML e CSS
...
Seu desafio é construir esta página de login e fazê-la parecer o mais próximo possível do design.
...
- Sua pagina não precisa ser funciona, pode apenas ser uma pagina estática de login para praticar os conhecimentos com HTML, CSS, se desafiar a desenvolver uma pagina de login conforme passamos o layout.
